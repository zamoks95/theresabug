<?php 
	...
	/**
	* Visual Composer Argenta Split box column inner shortcode
	*/

	add_shortcode( 'argenta_sc_split_box_column_inner', 'argenta_sc_split_box_column_inner_func' );

	function argenta_sc_split_box_column_inner_func( $atts, $content = '' ) {
	...
	if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
		class WPBakeryShortCode_Argenta_Sc_Split_Box_Column_Inner extends WPBakeryShortCodesContainer {
