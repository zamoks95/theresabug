<?php 
	...
	/**
	* Visual Composer Argenta Slider Inner shortcode
	*/

	add_shortcode( 'argenta_sc_slider_inner', 'argenta_sc_slider_inner_func' );

	function argenta_sc_slider_inner_func( $atts, $content_html = '' ) {
		...
		// Assembling
		ob_start();
		include( 'layout/slider_inner.php' );
	...
	vc_map( array(
		'name' => __( 'Section', 'argenta_extra' ),
		'description' => __( 'Slider section', 'argenta_extra' ),
		'base' => 'argenta_sc_slider_inner',
		'category' => __( 'Argenta', 'argenta_extra' ),
		'allowed_container_element' => 'vc_row',
		'is_container' => true,
		'show_settings_on_create' => false,
		'as_child' => array(
			'only' => 'argenta_sc_slider',
		),
		'js_view' => 'VcBackendTtaSectionView',
		'custom_markup' => '
			<div class="vc_tta-panel-heading">
				<h4 class="vc_tta-panel-title vc_tta-controls-icon-position-left"><a href="javascript:;" data-vc-target="[data-model-id=\'{{ model_id }}\']" data-vc-accordion data-vc-container=".wpb_argenta_sc_slider"><span class="vc_tta-title-text">{{ section_title }}</span><i class="vc_tta-controls-icon vc_tta-controls-icon-plus"></i></a></h4>
			</div>
	...
	if ( class_exists( 'VcShortcodeAutoloader' ) ) {
		...
		class WPBakeryShortCode_Argenta_Sc_Slider_Inner extends WPBakeryShortCode_VC_Tta_Accordion {
