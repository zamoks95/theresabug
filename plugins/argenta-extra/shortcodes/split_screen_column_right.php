<?php 
	...
	*/
	...
	add_shortcode( 'argenta_sc_split_screen_column_right', 'argenta_sc_split_screen_column_right_func' );

	function argenta_sc_split_screen_column_right_func( $atts, $content = '' ) {

		// Assembling
		ob_start();
		include( 'layout/split_screen_column_right.php' );
	...
	vc_map( array(
		...
		'base' => 'argenta_sc_split_screen_column_right',
	...
	if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
		class WPBakeryShortCode_Argenta_Sc_Split_Screen_Column_Right extends WPBakeryShortCodesContainer {
