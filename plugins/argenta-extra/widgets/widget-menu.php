...
class argenta_widget_navigation extends WP_Widget {
	private $_menu_directions;
	
	function __construct() {
		
		$this->_menu_directions = array(
			'left' => esc_html__( 'Left', 'argenta_extra' ),
			'right' => esc_html__( 'Right', 'argenta_extra' ),
			'center' => esc_html__( 'Center', 'argenta_extra' ),
		);
		
		parent::__construct(
			'argenta_widget_navigation',
			'Argenta: ' . esc_html__( 'Navigation', 'argenta_extra' ),
			array( 'description' => esc_html__( 'Sidebar navigation', 'argenta_extra' ) )
		);
	}
	...
	function form( $instance ) {
		...
		if ( ! $menus ) {
			echo '<p>'. sprintf( esc_html__( 'No menus have been created yet. %s Create some %s.', 'argenta_extra' ), '<a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '">', '</a>' ) . '</p>';
			return;
		}
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'nav_menu' ) ); ?>"><?php esc_html_e( 'Select Menu', 'argenta_extra' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'menu_direction' ) ); ?>"><?php esc_html_e( 'Menu Direction', 'argenta_extra' ); ?>:</label>
...
register_widget( 'argenta_widget_navigation' );
