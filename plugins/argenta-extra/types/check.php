<?php
	...
	/**
	* Visual Composer Argenta Check custom type
	*/

	if ( function_exists ( 'vc_add_shortcode_param' ) ) {
		vc_add_shortcode_param( 'argenta_check', 'argenta_extra_check_settings_field', plugins_url( 'check.js' , __FILE__ ) );
	}
	
	function argenta_extra_check_settings_field( $settings, $value ) {
