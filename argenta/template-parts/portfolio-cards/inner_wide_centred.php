...
?>
<div class="portfolio-item-2 portfolio-item-hover-4"
	<?php if ( $_project_uniqid ) { echo ' id="' . esc_attr( $_project_uniqid ) . '"'; } ?>
	...
	<div class="portfolio-item-description">
		...
		<div class="category subtitle-font"><?php echo wp_kses( $argenta_project['categories_plain'], 'default' ); ?></div>
		<?php endif; ?>
	</div>
